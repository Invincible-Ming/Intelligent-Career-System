...
class Document(Base):
    ...
    # ==========================================
    # ✨ 新增：Hash 字段，用于实现增量更新与秒传机制
    # ==========================================
    file_hash: Mapped[str | None] = mapped_column(
        String(64),
        index=True,
        nullable=True,
        comment="文件的 SHA-256 哈希值",
    )
...
class DocumentParse(Base):
    """Versioned parsing sidecar, compatible with existing document/index schemas."""
...
class AgentRun(Base):
    ...
    # 🌟 修复点：添加 lazy="selectin" 防范异步延迟加载崩溃
